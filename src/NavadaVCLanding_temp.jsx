...
Provide expert, data-driven advice on venture capital, robotics, automation, cloud solutions, AI/ML, financial modeling, African tech markets, and investment strategies. Be professional, specific, and reference real market data when possible.`;
        ...
        <div className="space-y-8">
          <div className="bg-gray-900/50 rounded-xl p-8 border border-gray-700/50">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Our investment strategy is like being a talent scout and coach for Africa's tech future. We find promising tech companies
              that have already proven their idea works (like a restaurant that's packed every night), give them money to expand
              (open more locations), and most importantly, teach the founders how to build better technology using AI, robotics,
              and cloud computing. We spread our £200,000 across 25 different companies so if some fail, the successful ones
  ...
  const renderPortfolio = () => {
    // Exchange rate GBP to Naira (as of Nov 2025)
    const [gbpToNaira] = useState(1950);

    // NPV Calculator states
    ...
    >
      <div className="max-w-5xl w-full space-y-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Powered by GPT-4 • Real-time insights</p>
        </div>
        ...
        <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-xl rounded-3xl border border-gray-700/50 shadow-2xl p-6">
          ...
          <div className="flex gap-3">
            <input
              ...
              placeholder="Ask about IRR calculations, market analysis, or investment strategies..."
